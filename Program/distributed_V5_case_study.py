...
Notes:
 ...
 - Outputs land in Results/Bidding under the same names a sequential V5 run
   writes. Every requested month also exports its hourly dsfunction workbook.
"""
...
# Every per-month CSV / .npy / dsfunction file and the summary are written into
# the isolated bidding directory, with no dated or parameter-tagged subfolder.
# Reusing v5.RESULTS_DIR keeps one definition of that location for sequential
# and distributed bidding runs:
#   Results/Bidding/summary_202301_202512_exact_V5_k20.csv
#       -> Program/analyze_summary.py (its default input)
#       -> Results/Bidding/analysis_202301_202512.xlsx (source data for Figure 4d)
#   Results/Bidding/April2025_eta95%_std2_exact_V5_k20.csv
...
def run_single_month(num):
    ...
    summary, detection_counts = v5.run_one_month(
        num, export_dsfunctions=True, return_detection_counts=True
    )
